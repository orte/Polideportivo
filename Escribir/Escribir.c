...
int EscribirReserva(char *nom_us, char *nom_ins,char fecha_[128]) 
  {
  FILE* f; //file pointer
  ...
  fprintf(f, "Reservas : \n" );
   ...
   fprintf(f, " Nombre de usuario : %s\t \t Nombre de instalacion : %s \t \t Fecha: %s \n", nombre_us,nombre_ins,fecha); //Escribir en fichero
